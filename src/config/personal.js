...
export const AUTORIZACIONES_CATALOGO = {
  // Ensayos mecanicos
  ens_traccion: {
    id: 'ens_traccion',
...
export const CATEGORIAS_AUTORIZACION = {
...
/**
 * Obtiene la informacion de un cargo por su ID
 */
export function getCargoInfo(cargoId) {
  return (
    CARGOS[cargoId] || {
      id: cargoId || 'desconocido',
 ...
 */
export function getCargosInternos() {
  return Object.entries(CARGOS).filter(([key]) => key !== 'cliente');
}
