...
import { CARGOS, getCargosInternos, CargoId } from '../../../config/personal';
...
type TipoPersona = 'interno' | 'cliente';
...
export default function AgregarPersonaModal({
  ...
  onClose,
  onSave,
}: AgregarPersonaModalProps): ReactElement {
  const [tipoPersona, setTipoPersona] = useState<TipoPersona>('interno');
      ...
      <form onSubmit={handleSubmit}>
        ...
        {tipoPersona === 'interno' ? (
          <div className={styles.formField}>
            ...
            {form.cargo && CARGOS[form.cargo as CargoId] && (
              <div className={styles.cargoHint}>{CARGOS[form.cargo as CargoId].descripcion}</div>
            )}
          </div>
        ) : (
          <>
