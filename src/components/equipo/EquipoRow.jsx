  ...
  return (
    <>
      <tr onClick={onToggle} className={isExpanded ? styles.rowExpanded : styles.row}>
        ...
        <td className={styles.cellSmall}>{equipo.rango}</td>
        <td className={styles.cellText}>{equipo.ubicacion}</td>
        <td className={styles.cell}>
          <Badge color={estadoInfo.color}>{estadoInfo.label}</Badge>
        </td>
        <td className={styles.cellDate}>
          <div className={styles.dateText}>{formatDate(equipo.proxima_calibracion)}</div>
          {alertaCalib && (
            <span
        ...
        <td className={styles.cellDate}>
          {equipo.proxima_comprobacion ? (
            <>
              <div className={styles.dateText}>{formatDate(equipo.proxima_comprobacion)}</div>
              {alertaComprob && (
                <span
                  className={styles.alertTag}
            ...
            <div className={styles.expandedContent}>
              ...
              <div className={styles.infoGrid}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div className={styles.infoValue}>{equipo.resolucion || '-'}</div>
                </div>
                <div className={styles.infoItem}>
                  <div className={styles.infoLabel}>Responsable</div>
                  <div className={styles.infoValue}>{equipo.responsable}</div>
                </div>
                <div className={styles.infoItem}>
                  <div className={styles.infoLabel}>Fecha Adquisicion</div>
                  <div className={styles.infoValue}>{formatDate(equipo.fecha_adquisicion)}</div>
                </div>
                {equipo.factor_calibracion && (
                  <div className={styles.infoItem}>
                    <div className={styles.infoLabel}>Factor de Calibracion</div>
                    <div className={styles.infoValueHighlight}>{equipo.factor_calibracion}</div>
                  </div>
                )}
                {equipo.observaciones && (
                  <div className={styles.infoItemWide}>
                    <div className={styles.infoLabel}>Observaciones</div>
                    <div className={styles.infoValueItalic}>{equipo.observaciones}</div>
                  </div>
                )}
              </div>
