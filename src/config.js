...
export const DB_CONFIG = {
  ...
  sheets: {
    proyectos: {
      name: 'Proyectos',
      columns: [
        'id', 'codigo', 'nombre', 'descripcion', 'cliente_id', 'cliente_nombre',
        'contacto', 'estado', 'fecha_inicio', 'fecha_fin_estimada', 'fecha_fin_real',
        'drive_folder_id', 'created_at', 'updated_at', 'created_by',
      ],
    },
    perforaciones: {
      name: 'Perforaciones',
      columns: [
        'id', 'codigo', 'proyecto_id', 'descripcion', 'ubicacion', 'profundidad',
        'fecha_solicitud', 'estado', 'drive_folder_id', 'created_at', 'updated_at',
      ],
    },
    ensayos: {
      name: 'Ensayos',
      columns: [
        'id', 'codigo', 'tipo', 'perforacion_id', 'proyecto_id', 'cliente_id',
        'muestra', 'norma', 'workflow_state', 'fecha_solicitud', 'fecha_programada',
        'fecha_ejecucion', 'fecha_entrega', 'tecnico_id', 'tecnico_nombre',
        'sheet_id', 'sheet_url', 'informe_id', 'informe_url', 'observaciones',
        'urgente', 'created_at', 'updated_at',
      ],
    },
    clientes: {
      name: 'Clientes',
      columns: [
        'id', 'codigo', 'nombre', 'rut', 'direccion', 'ciudad', 'telefono',
        'email', 'contacto_nombre', 'contacto_cargo', 'contacto_email',
        'contacto_telefono', 'activo', 'drive_folder_id', 'created_at', 'updated_at',
      ],
    },
    usuarios: {
      name: 'Usuarios',
      columns: [
        'id', 'email', 'nombre', 'apellido', 'rol', 'cargo', 'telefono',
        'activo', 'cliente_id', 'last_login', 'created_at', 'updated_at',
      ],
    },
    equipos: {
      name: 'Equipos',
      columns: [
        'id', 'codigo', 'nombre', 'marca', 'modelo', 'serie', 'ubicacion',
        'estado', 'fecha_calibracion', 'proxima_calibracion', 'certificado_id',
        'responsable', 'observaciones', 'created_at', 'updated_at',
      ],
    },
    logs: {
      name: 'Logs',
      columns: [
        'id', 'timestamp', 'usuario_id', 'usuario_nombre', 'accion', 'entidad',
        'entidad_id', 'datos_antes', 'datos_despues', 'ip', 'user_agent',
      ],
    },
  },
...
export const WORKFLOW_STATES_INFO = {
  E1: { nombre: 'Sin programación', color: '#9CA3AF', fase: 'inicial', descripcion: 'Esperando programación' },
  E2: { nombre: 'Programado', color: '#F59E0B', fase: 'inicial', descripcion: 'Programado sin ejecutar' },
  E3: { nombre: 'Anulado', color: '#EF4444', fase: 'terminal', descripcion: 'Ensayo anulado' },
  E4: { nombre: 'Repetición', color: '#F97316', fase: 'inicial', descripcion: 'Requiere repetición' },
  E5: { nombre: 'Novedad', color: '#EAB308', fase: 'inicial', descripcion: 'Presenta novedad' },
  E6: { nombre: 'En ejecución', color: '#3B82F6', fase: 'ejecucion', descripcion: 'Ensayo en curso' },
  E7: { nombre: 'Espera ensayos', color: '#6366F1', fase: 'ejecucion', descripcion: 'Esperando otros ensayos' },
  E8: { nombre: 'Procesamiento', color: '#8B5CF6', fase: 'ejecucion', descripcion: 'Procesando datos' },
  E9: { nombre: 'Rev. Técnica', color: '#A855F7', fase: 'revision', descripcion: 'En revisión técnica' },
  E10: { nombre: 'Rev. Coordinación', color: '#D946EF', fase: 'revision', descripcion: 'En revisión de coordinación' },
  E11: { nombre: 'Rev. Dirección', color: '#EC4899', fase: 'revision', descripcion: 'En revisión de dirección' },
  E12: { nombre: 'Por enviar', color: '#14B8A6', fase: 'entrega', descripcion: 'Listo para enviar' },
  E13: { nombre: 'Enviado', color: '#10B981', fase: 'entrega', descripcion: 'Enviado al cliente' },
  E14: { nombre: 'Entregado', color: '#22C55E', fase: 'entrega', descripcion: 'Entregado y confirmado' },
  E15: { nombre: 'Facturado', color: '#16A34A', fase: 'terminal', descripcion: 'Facturado y cerrado' },
};
...
export const getWorkflowInfo = (state) => 
  WORKFLOW_STATES_INFO[state] || { nombre: 'Desconocido', color: '#6B7280', fase: 'unknown', descripcion: '' };
...
export const TIPOS_ENSAYO = [
  ...
  { id: 'metalografia', nombre: 'Análisis Metalográfico', categoria: 'metalografia', norma: 'ASTM E3' },
  { id: 'calibracion', nombre: 'Calibración de Equipos', categoria: 'calibracion', norma: 'ISO 17025' },
];
...
export const getTipoEnsayo = (tipoId) => 
  TIPOS_ENSAYO.find(t => t.id === tipoId) || { id: tipoId, nombre: tipoId, categoria: 'otro', norma: '' };
...
export const NAV_ITEMS = [ 
  { label: 'Dashboard', path: '/dashboard', icon: 'dashboard', roles: ['admin', 'coordinador', 'tecnico', 'cliente'] },
  { label: 'Proyectos', path: '/proyectos', icon: 'folder', roles: ['admin', 'coordinador', 'tecnico'] },
  ...
  { label: 'Equipos', path: '/equipos', icon: 'equipment', roles: ['admin', 'coordinador', 'tecnico'] },
...
export const DASHBOARD_STATS = [
  ...
  { key: 'completados', label: 'Completados', icon: 'completed', estados: ['E12', 'E13', 'E14', 'E15'] },
