...
USING (VALUES
    ('EQ-BAL-001', 'EQ-BAL-001', N'Balanza analítica',  'SAR-MS204-2024', N'Sartorius', 'MS204',   N'Laboratorio Físicos', 'disponible', N'Balanza analítica de precisión 0.0001 g',     N'Demo Técnico', CAST(1 AS BIT)),
    ('EQ-HRN-001', 'EQ-HRN-001', N'Horno de secado',    'MEM-UF55-2023',  N'Memmert',   'UF55',    N'Laboratorio Suelos',  'disponible', N'Horno universal de secado hasta 250 °C',      N'Demo Técnico', CAST(1 AS BIT)),
    ('EQ-PRN-001', 'EQ-PRN-001', N'Prensa CBR',         'ELE-2150-2022',  N'ELE',       '26-2150', N'Laboratorio Suelos',  'disponible', N'Prensa de compresión 50 kN para CBR',         N'Demo Técnico', CAST(1 AS BIT))
